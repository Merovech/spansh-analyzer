...
class PopulationCounter(ProcessorBase):
    def __init__(self):
        super().__init__()
    ...
    def Completed(self) -> None:
        log.writeln(f"Total population found: {self.__total_population}")
        log.writeln(f"Average per populated system: {self.__total_population // self.__total_populated_systems}")